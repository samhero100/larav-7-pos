                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($suppliers as $index=>$supplier)
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('create_orders_suppliers'))
                                            <a href="{{ route('dashboard.suppliers.orders.create', $supplier->id) }}" class="btn btn-primary btn-sm">@lang('site.add_order')</a>
                                       @endif
                                    </td>
                                    <td>
                                        @if (auth()->user()->hasPermission('create_orders_suppliers_return'))
                                            <a href="{{ route('dashboard.suppliers.orders_return.create', $supplier->id) }}" class="btn btn-primary btn-sm">@lang('site.add_order_return')</a>
                                       @endif
                                    </td>
