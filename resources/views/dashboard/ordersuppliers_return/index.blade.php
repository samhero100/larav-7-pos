                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <h3 class="box-title" style="margin-bottom: 10px">@lang('site.orders_suppliers_return')</h3>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (auth()->user()->hasPermission('update_orders_suppliers'))
                                                    <a href="{{ route('dashboard.suppliers.orders_return.edit', ['supplier' => $order->supplier->id, 'orders_return' => $order->id]) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> @lang('site.edit')</a>
                                                @endif

                                                @if (auth()->user()->hasPermission('delete_orders_suppliers'))
                                                    <form action="{{ route('dashboard.ordersuppliers_return.destroy', $order->id) }}" method="post" style="display: inline-block;">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
